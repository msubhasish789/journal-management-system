...
<body>
    ...
    <section class="home pending_manu">
        <h2>Reject Manuscripts</h2>
        <div>
            <?php
         $sql = "SELECT `Manuscript id`, `Manu Name` AS `ManuscriptName`, `Description`,`Submission date`, `FileContent`, `Status` FROM `Manuscript Submission` 
         WHERE `Status`=-1;";
